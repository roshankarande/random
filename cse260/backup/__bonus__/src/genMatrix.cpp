...
void matMulHost(_FTYPE_ *C, const _FTYPE_ *A, const _FTYPE_ *B, unsigned int M, unsigned int K, unsigned int N);
void reference_dgemm(unsigned int n, _FTYPE_ Alpha, _FTYPE_ *a, _FTYPE_ *b, _FTYPE_ *c);
void reference_dgemm(unsigned int m, unsigned int k, unsigned int n, _FTYPE_ Alpha, _FTYPE_ *a, _FTYPE_ *b, _FTYPE_ *c);
...
void verify_ISeq(_FTYPE_ *c, unsigned int m, unsigned int k, unsigned int n)
{
    _FTYPE_ x = 1.0;
    _FTYPE_ *cptr = c;
    for (unsigned int i = 0; i < m; i++)
